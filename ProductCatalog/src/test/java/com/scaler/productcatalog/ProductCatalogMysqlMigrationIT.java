...
/**
 * Boots the full application context against a real MySQL 8.4 container so that
 * the Flyway migrations apply from an empty database and Hibernate
...
class ProductCatalogMysqlMigrationIT {

    @Container
    static final MySQLContainer<?> MYSQL = new MySQLContainer<>("mysql:8.4")
            .withDatabaseName("product_catalog_db");
