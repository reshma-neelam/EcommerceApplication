...
CREATE INDEX IF NOT EXISTS idx_product_status_deleted ON product(status, deleted_at);
...
CREATE INDEX IF NOT EXISTS idx_prodcat_category ON product_category(category_id, product_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_reservation_order_product ON inventory_reservation(order_id, product_id);
CREATE INDEX IF NOT EXISTS idx_reservation_status_expires ON inventory_reservation(status, expires_at);
CREATE INDEX IF NOT EXISTS idx_reservation_product_status ON inventory_reservation(product_id, status);
...
CREATE INDEX IF NOT EXISTS idx_image_product_order ON product_image(product_id, display_order);
